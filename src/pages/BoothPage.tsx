...
const maxPhotos = 
  ...
  currentLayout === 'horizontal-2x2' ? 3 : 
  currentLayout === 'grid-2x3' ? 6 :
  4; // default untuk vertical-4
  ...
  const getLayoutDescription = () => {
    if (currentLayout === 'horizontal-2x2') return '3 photos';
        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">
              Selected: {currentLayout === 'horizontal-2x2' ? 'Layout B' : 
                         currentLayout === 'vertical-4' ? 'Layout A' : 
                         'Layout C'} ({getLayoutDescription()})
            </p>
          </div>
          <button
            onClick={() => navigate('/')}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                {isCapturing ? `Photo ${photos.length + 1}/${maxPhotos}` : 'Start Capture'}
              </button>
            ...
            <div className="bg-gray-800/30 backdrop-blur-md rounded-2xl p-6 shadow-xl border border-gray-700/50">
              <FilterPanel
